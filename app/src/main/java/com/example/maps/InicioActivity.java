...
public class InicioActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnMapLongClickListener, GoogleMap.OnMapClickListener, GoogleMap.OnMarkerClickListener {
    Context context;
    GoogleMap map;
    ...
    public void onMapLongClick(LatLng latLng) {
        ...
        Toast.makeText(InicioActivity.this, "Select the icon", Toast.LENGTH_SHORT).show();
    ...
    public  class MyAsyncTask extends AsyncTask<Integer, Integer, String> {
        ...
        protected void onProgressUpdate(Integer... values) {
            ...
            if (values[0] == 0) {
                ...
                Toast.makeText(InicioActivity.this, "LISTO", Toast.LENGTH_SHORT).show();
